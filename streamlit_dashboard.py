...
def generate_pdf_report(df_filtered, date_range, branches, cities):
    ...
    story.append(Paragraph("Walmart Sales Analytics Report", title_style))
    ...
    story.append(Paragraph(f"Report generated by Walmart Sales Analytics Dashboard", normal_style))
...
def main():
    ...
    st.markdown('<h1 class="main-header">🛒 Walmart Sales Analytics Dashboard</h1>', unsafe_allow_html=True)
